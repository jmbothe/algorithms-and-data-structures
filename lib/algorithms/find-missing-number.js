...
/**
 * Finds the missing number in an array of integers from x to n (incrementing by +1) with one number missing.  {@link ./lib/algorithms/find-missing-number.js|Sourcecode}.
 * @memberof algo
