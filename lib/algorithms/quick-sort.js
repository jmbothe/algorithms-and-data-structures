...
/**
 * Sorts an array according to a specified sort order. Worst-case time complexity is O(n log n). {@link ./lib/algorithms/quick-sort.js|Sourcecode}.
 * @memberof algo
 ...
 * @param {function} compare Specifies a function that determines sort order. More info at {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/sort#Description|MDN - Array.sort()}.
